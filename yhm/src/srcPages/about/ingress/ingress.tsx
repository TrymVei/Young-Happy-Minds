      ...
      <section>
        <div className={style.about__flex}>
          <div>
            ...
            <div className={style.about__flex__desktop}>
              <p>
                Young Happy Minds ble stiftet i England i 2017 av Martine Kveim
                og Yvonne Biggins. YHM har gjennom lokale lag holdt kurs og
                foredrag i over 15 land, til alt fra barn og unge i fengsler og
                flyktningeleirer, skoler og SFO til generaler i den Britiske
                Hær. I Norge drives Young Happy Minds primært av Karina Hollekim
                (leder digitalt innhold) og Martine Kveim (fagansvarlig).
              </p>
              <p>
                Representanter fra Young Happy Minds har blant annet vært med; å
                forme "Oxford University Wellbeing Curriculum", vært
                representert i House of Lords sin arbeidsgruppe om å forme nytt
                barneskolepensum i England, sittet i designgruppen til
                Kronprinsparets fond om livsmestrings-prosjektet for ungdom
                "Flyt" og vært involvert i å utarbeide en rapport for Barne- og
          ...
          <div className={style.about__flex__mobile}>
            <p>
        ...
        <div className={style.about__imageSection}>
          <img src="/images/about-imagesection-1.png" alt="s" />
          <img src="/images/about-imagesection-2.png" alt="s" />
          <img src="/images/about-imagesection-3.png" alt="s" />
        </div>
      </section>
    </div>
  );
